...
router.post('/', async (req, res) => {
    const { exam_name, course_name, question_number, ta_name, comments } = req.body;

    if (!exam_name || !course_name || !question_number || !ta_name) {
    ...
    // if comments
    const newStd = new Query({ exam_name, course_name, question_number, ta_name, comments });
